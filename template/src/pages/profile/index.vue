<template>
  <div class="scroll-box no-scrollbar">
    <div class="top">
      <div class="user-info">
        <img class="avatar" src="../../assets/logo.png" :onerror="`this.src = '${icon}'`" />
        <p class="name">vincent-cli</p>
      </div>
    </div>

    <mt-cell title="修改密码" is-link>
      <img slot="icon" class="cell-icon" :src="icon" width="21" >
    </mt-cell>
